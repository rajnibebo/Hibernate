 ...
 *
 */
public class MonetaryAmountConversionType implements CompositeUserType, ParameterizedType {
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index,
		...
		if(value == null) {
			...
			MonetaryAmount dbAmount = monetaryAmount.converTo(convertTo);
			st.setBigDecimal(index, dbAmount.getAmount());
